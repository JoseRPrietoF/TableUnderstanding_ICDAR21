...
work_path_gnn2=work_icdar19_abp_small_graph_${conjugate}_BL_${loss}_${ngf}ngfs_base_notext_original_${model}_pruned
## GNN1
...
epoch=200
## GNN2
python3.6 main_graph.py --batch_size 100 \
--data_path  ${data_path} \
--epochs ${epoch} \
--do_prune True \
--results_prune_te ${work_path}/results.txt \
--results_prune_tr ${work_path}/results_train.txt \
--work_dir ${work_path_gnn2} \
--fold_paths /data2/jose/corpus/tablas_DU/icdar19_abp_small \
--layers ${ngf} --adam_lr 0.005 --conjugate ${conjugate} --classify CELLS --show_test 300 --load_model True